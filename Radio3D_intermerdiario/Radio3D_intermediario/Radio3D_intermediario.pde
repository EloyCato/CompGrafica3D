...
void draw(){
  background(120);
  camera(1453, 3, -1184, 224, 181, 11, 0.0, 0.8, 0.0);
  rotateX(0.01*PI);
  rotateY(-0.02*PI);
  rotateZ(0.00*PI);
  ...
  fill(59,47,177);//azul
  cubo(50,-30, 50, 500,400,200,0.0,0.0,0.0);// corpo principipal
  fill(69,177,47);//verde
  cubo(50,50, -30, 500,300,360,0.0,0.0,0.0);// corpo principipal
  fill(175,47,177);//roxo
  cubo(-30,50, 50, 660,300,200,0.0,0.0,0.0);// corpo principipal
